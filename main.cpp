...
#include "./day-4/day4-part1.hpp"
#include "./day-4/day4-part2.hpp"
#include "./day-5/day5-part1.hpp"
#include "./day-6/day6-part1.hpp"
...
int main(int argc, const char * argv[]) {
    ...
    // std::cout << validGames() << '\n';
    // std::cout << gearRatios();
    // std::cout << "Total points across all cards: " << totalPoints();
    // std::cout << "Total cards won: " << totalCards();
    // std::cout << "Lowest location: " << lowestLocation();
    ...
    // Day 14 part 1
    // std::cout << "Total load for part 1: " << totalLoadPart1();
    // std::cout << '\n';
    ...
    // Day 18 Part 1
    // std::cout << "Cubic meters of lava part 1: " << cubicMetersLavaPart1();
    // std::cout << '\n';
    ...
    // Day 22 Part 1
    // std::cout << "Count of bricks that can be safely distintegrated part 1: " << safeToDisintegrateBrickCount() << '\n';
